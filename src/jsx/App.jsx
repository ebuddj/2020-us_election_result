    ...
    return (
      <div className={style.plus}>
        ...
        <div className={style.meta_container}>
          ...
          <div className={style.clearfix}><label>Source</label><span className={style.value}>DPA</span> <label>Updated</label><span className={style.value}>6.11.2020 16:42 UTC</span></div>
        </div>
      </div>
    );
  }
